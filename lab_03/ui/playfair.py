...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.txt_key.setGeometry(QtCore.QRect(150, 190, 631, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.txt_key.setFont(font)
        self.txt_key.setObjectName("txt_key")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(570, 580, 121, 51))
        font = QtGui.QFont()
        ...
        self.label_3.setGeometry(QtCore.QRect(10, 240, 131, 61))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(20)
        ...
        self.txt_plain_text.setGeometry(QtCore.QRect(150, 70, 631, 101))
        font = QtGui.QFont()
        font.setPointSize(20)
        ...
        self.btn_encrypt.setGeometry(QtCore.QRect(50, 580, 121, 51))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(20)
        font.setBold(True)
        ...
        self.label.setGeometry(QtCore.QRect(210, 0, 371, 51))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        ...
        self.txt_cipher.setGeometry(QtCore.QRect(150, 260, 631, 101))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.txt_cipher.setFont(font)
        self.txt_cipher.setObjectName("txt_cipher")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(10, 190, 71, 41))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(20)
        ...
        self.table_playfair.setGeometry(QtCore.QRect(150, 370, 521, 181))
